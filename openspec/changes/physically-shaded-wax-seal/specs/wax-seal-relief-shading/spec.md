# Delta Spec: Wax Seal Relief Shading
...
- Procedural 36-point spline wax outline with radial gradient fill.
- Stroked-arc inner rim wall highlight/shadow.
- Offset-copy bevel & emboss (black and white shifted emblem copies).
- Diagonal white-stripe "metallic" overlay.
