...
export const PANEL_STRINGS = {
  ...
  // ── QR Code Tab ───────────────────────────────────────────────────────────
  qrGroupTheme: { ES: 'Diseño y formato', EN: 'Design & format' },
  qrThemeLabel: { ES: 'Tema de la tarjeta', EN: 'Card theme' },
  qrThemeParchment: { ES: 'Pergamino Clásico', EN: 'Classic Parchment' },
  qrThemeMinimalWhite: { ES: 'Blanco Minimalista', EN: 'Minimalist White' },
  qrThemeModernDark: { ES: 'Oscuro Elegante', EN: 'Modern Luxury Dark' },
  qrThemeGoldenBorder: { ES: 'Borde Dorado', EN: 'Golden Border' },
  qrSizeLabel: { ES: 'Tamaño de impresión', EN: 'Print card size' },
  qrSize4x6: { ES: 'Postal (4×6 pulg / 10×15 cm)', EN: 'Postcard (4×6 in / 10×15 cm)' },
  qrSize35x2: { ES: 'Tarjeta personal (3.5×2 pulg)', EN: 'Place card (3.5×2 in)' },
  qrSizeA6: { ES: 'Estándar A6 (105×148 mm)', EN: 'Standard A6 (105×148 mm)' },
  qrSizeSquare: { ES: 'Cuadrada (4×4 pulg)', EN: 'Square (4×4 in)' },
  qrOrientationLabel: { ES: 'Orientación', EN: 'Orientation' },
  qrOrientationPortrait: { ES: 'Vertical', EN: 'Portrait' },
  qrOrientationLandscape: { ES: 'Horizontal', EN: 'Landscape' },
  qrGroupContent: { ES: 'Contenido y textos', EN: 'Content & wording' },
  qrHeadlineLabel: { ES: 'Título o encabezado', EN: 'Headline or title' },
  qrHeadlinePlaceholder: { ES: 'Nuestra Boda / Evento', EN: 'Our Wedding / Event' },
  qrInstructionsLabel: { ES: 'Instrucciones de escaneo', EN: 'Scan instructions' },
  qrInstructionsDefault: {
    ES: 'Escanea con la cámara de tu celular para ver la invitación y confirmar asistencia',
    EN: 'Scan with your phone camera to view the invitation and RSVP',
  },
  qrIncludeGuestName: { ES: 'Personalizar con nombre del invitado', EN: 'Personalize with guest name' },
  qrIncludeSealLogo: { ES: 'Incluir sello de cera en el centro del QR', EN: 'Include wax seal in QR center' },
  qrShowDate: { ES: 'Mostrar fecha del evento', EN: 'Show event date' },
  qrColorLabel: { ES: 'Color del código QR', EN: 'QR code color' },
  qrSampleGuest: { ES: 'Familia González / Nombre del Invitado', EN: 'The Gonzalez Family / Guest Name' },
  qrPrintSampleBtn: { ES: '🖨️ Imprimir prueba', EN: '🖨️ Print sample' },
  qrDownloadPngBtn: { ES: '⬇️ Descargar PNG (300 DPI)', EN: '⬇️ Download PNG (300 DPI)' },
  qrModalTitle: { ES: 'Tarjeta QR de Invitación', EN: 'Invitation QR Card' },
  qrModalSubtitle: { ES: 'Lista para imprimir y entregar en mano', EN: 'Ready to print and hand out physically' },
  qrModalPrint: { ES: '🖨️ Imprimir tarjeta', EN: '🖨️ Print card' },
  qrModalDownload: { ES: '⬇️ Descargar imagen', EN: '⬇️ Download image' },
  qrModalCopyLink: { ES: '📋 Copiar enlace', EN: '📋 Copy link' },
